-- Quick Product Insert for Neon PostgreSQL
-- Run this directly in your Neon SQL console to add sample products
...
SELECT id, name, price, category FROM product ORDER BY id;
